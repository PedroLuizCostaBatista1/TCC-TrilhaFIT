        ...
        <div style="background: linear-gradient(135deg, #FF5C00 0%, #FF8A3D 100%); max-width: 390px; width: 100%; margin: 0 auto; padding: 0; min-height: 100%; display: flex; flex-direction: column; position: relative; z-index: 1;">
            <div style="flex: 1; overflow-y: auto;">
                <div style="padding: 24px 20px;">
                    <h2 style="font-size: 24px; font-weight: 800; color: #FFFFFF; margin-bottom: 20px; text-shadow: 0 2px 8px rgba(0,0,0,0.15);">Placar</h2>
                    <div style="background: rgba(255, 255, 255, 0.15); border-radius: 16px; padding: 16px; margin-bottom: 20px; backdrop-filter: blur(10px); border: 1px solid rgba(255, 255, 255, 0.2);">
